...
cdef EvalLoglikelihood eval_loglikelihood(
    ...
    cdef:
        double l_plus = log(v_D[0])
        double l_D_minus = 0.0
        double l_A_minus = 0.0
      
        double l_plus_alpha_0 = v_D_alpha_0[0] / v_D[0]
        double l_plus_alpha_1 = v_D_alpha_1[0] / v_D[0]
        double l_plus_alpha_2 = v_D_alpha_2[0] / v_D[0]
        double l_plus_beta = v_D_beta[0] / v_D[0]
    ...
    for j in range(J - 1):        
        ...
        l_plus_alpha_0 += v_D_alpha_0.back() / v_D.back()
        l_plus_alpha_1 += v_D_alpha_1.back() / v_D.back()
        l_plus_alpha_2 += v_D_alpha_2.back() / v_D.back()
        l_plus_beta += v_D_beta.back() / v_D.back()
    ...
    res.gradient = vector[double](9, 0.0)
    ...
    res.gradient[4] = -l_A_minus_alpha_0
    res.gradient[5] = -l_A_minus_alpha_1
    res.gradient[6] = -l_A_minus_alpha_2
    res.gradient[7] = -l_A_minus_beta
    res.gradient[8] = -l_A_minus_nu
    return res
